...
- ローカルで次の確認が通ること
  ...
  - `cargo test`
- `yourorg/homebrew-tap` リポジトリが作成済みであること
...
### 3. GitHub Release から Homebrew 用の値を取得
...
```text
https://github.com/yourorg/minishelf/releases/download/v<version>/minishelf-<version>-aarch64-apple-darwin.tar.gz
```

### 4. `yourorg/homebrew-tap` の Formula を手動更新
